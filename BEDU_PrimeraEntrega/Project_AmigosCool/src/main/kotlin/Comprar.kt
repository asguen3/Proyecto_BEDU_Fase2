        ...
        while (i <= cantidad) {
            ...
            var result = when (talla) {
                "CH" -> if (color == "B") {
                    ...
                    precio = 210
                } else {println("El color de la playera : $color la talla  : $talla  precio $ ${240}")
                    precio = 240
                }
